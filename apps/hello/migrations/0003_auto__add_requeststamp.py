...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RequestStamp'
        db.create_table(u'hello_requeststamp', (
        ...
        db.send_create_signal(u'hello', ['RequestStamp'])


    def backwards(self, orm):
        # Deleting model 'RequestStamp'
        db.delete_table(u'hello_requeststamp')
    ...
    models = {
        ...
        u'hello.requeststamp': {
            'Meta': {'object_name': 'RequestStamp'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
